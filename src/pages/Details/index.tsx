...
import { DetailText, DetailsContainer, DetailsHeader, InfoList, Title } from "./styles";
...
export function Details() {
  ...
  const date = formatDistanceToNow(new Date(posts.created_at), {addSuffix: true, locale: ptBR,})
      ...
      <DetailsContainer>
        <DetailsHeader>
          <nav>
            ...
            <a href="#" target="_blank">ver no github<FontAwesomeIcon icon={faArrowUpRightFromSquare} /></a>
          </nav>
          <Title>{posts.title}</Title>
          <InfoList>
            <li><FontAwesomeIcon icon={faGithub} />{posts.login}</li>
            <li><FontAwesomeIcon icon={faCalendarDay} />{date}</li>
            <li><FontAwesomeIcon icon={faComment} />{posts.comments} comentários</li>
          </InfoList>
        </DetailsHeader>
